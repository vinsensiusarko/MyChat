...
import arko.chatapp.Notifications.MyFirebaseMessaging;

import static arko.chatapp.IncomingCallScreenActivity.ACTION_ANSWER;
import static arko.chatapp.IncomingCallScreenActivity.ACTION_IGNORE;
import static arko.chatapp.IncomingCallScreenActivity.EXTRA_ID;
import static arko.chatapp.IncomingCallScreenActivity.MESSAGE_ID;
...
public class SinchService extends Service {
    ...
    private void start() {
        ...
        try {
            ...
            } else if (getApplicationContext().checkCallingOrSelfPermission(Manifest.permission.RECORD_AUDIO)!= PackageManager.PERMISSION_GRANTED) {

                throw new MissingPermissionException(Manifest.permission.RECORD_AUDIO);
            } else if (getApplicationContext().checkCallingOrSelfPermission(Manifest.permission.WRITE_EXTERNAL_STORAGE)!= PackageManager.PERMISSION_GRANTED) {

                throw new MissingPermissionException(Manifest.permission.READ_PHONE_STATE);
            } else if (getApplicationContext().checkCallingOrSelfPermission(Manifest.permission.CAMERA)!= PackageManager.PERMISSION_GRANTED) {
    ...
    private class SinchCallClientListener implements CallClientListener {
        ...
        private Notification createIncomingCallNotification(String userId, Intent fullScreenIntent) {
            ...
            NotificationCompat.Builder builder =
                    new NotificationCompat.Builder(getApplicationContext(), MyFirebaseMessaging.CHANNEL_ID)
